...
export const validateBCCompanyExtraFields = (data: CustomFieldItems): CustomFieldItems =>
  B3Request.post('/api/v2/extra-fields/company/validate', RequestType.B2BRest, {
    ...data,
    storeHash,
  });

export const validateBCCompanyUserExtraFields = (data: CustomFieldItems): CustomFieldItems =>
