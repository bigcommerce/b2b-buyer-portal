...
export type Query = {
  ...
  /**
   * Get extra fields in the company configurations.
   * Doesn't require a Token.
   */
   ...
   * Requires a BC Token.
   */
  customerShoppingListsIdName?: Maybe<
    Array<Maybe<CustomerShoppingListIdNameType>>
  >
  /**
