...
describe('B3CompanyHierarchy', () => {
  describe('when company hierarchy representation is active', () => {
    it('should show company hierarchy dropdown with representing company chip', () => {
  ...
  describe('when no company hierarchy representation is active', () => {
    it('should show current company chip only', () => {
      const preloadedState = {
        company: buildCompanyStateWith({
          companyHierarchyInfo: {
  ...
  describe('when user lacks permissions', () => {
    it('should not render when no subsidiaries permissions are granted', () => {
      const preloadedState = {
        company: buildCompanyStateWith({
          companyHierarchyInfo: {
            selectCompanyHierarchyId: '',
