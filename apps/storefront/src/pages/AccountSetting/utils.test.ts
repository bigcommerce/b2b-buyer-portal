...
describe('initB2BInfo', () => {
  ...
  it('overrides contact defaults with matching extra field values', () => {
    ...
    const [result] = initB2BInfo(accountSettings, contactInformation, [], []);
  ...
  it('ignores extra fields with no matching contact field', () => {
    ...
    const [result] = initB2BInfo(
      { ...accountSettings, extraFields: [{ fieldName: 'unknown', fieldValue: 'x' }] },
      contactInformation,
      [],
      [],
    );
  ...
  it('sets and disables the role and company B2B form fields', () => {
    ...
    const result = initB2BInfo(accountSettings, [], accountB2BFormFields, []);
  ...
  it('maps additional information defaults from matching form fields', () => {
    ...
    const result = initB2BInfo(accountSettings, [], [], additionalInformation);
...
describe('initBcInfo', () => {
  ...
  it('maps additional information defaults from matching form fields', () => {
    ...
    const [result] = initBcInfo(accountSettings, [], additionalInformation);
...
describe('b2bSubmitDataProcessing', () => {
  ...
  it('returns undefined when nothing changed (pristine)', () => {
    ...
    expect(b2bSubmitDataProcessing(data, accountSettings, decryptionFields, [])).toBeUndefined();
  });
  ...
  it('collects changed contact fields and drops company/role from the payload', () => {
    ...
    const result = b2bSubmitDataProcessing(data, accountSettings, decryptionFields, []);
  ...
  it('marks the form dirty when a custom decryption field value changes', () => {
    ...
    const result = b2bSubmitDataProcessing(data, accountSettings, customDecryptionFields, []);
  ...
  it('pushes form-field changes using the bcLabel and detects a changed value', () => {
    ...
    const result = b2bSubmitDataProcessing(data, accountSettings, [], extraFields);
  ...
  it('maps password to newPassword and marks the form dirty', () => {
    ...
    const result = b2bSubmitDataProcessing(data, accountSettings, [], []);
  ...
  it('stays pristine (returns undefined) when only an unknown key changes', () => {
    ...
    expect(b2bSubmitDataProcessing(data, accountSettings, [], [])).toBeUndefined();
  });
});
...
describe('bcSubmitDataProcessing', () => {
  ...
  it('returns undefined when nothing changed (pristine)', () => {
    ...
    expect(bcSubmitDataProcessing(data, accountSettings, decryptionFields, [])).toBeUndefined();
  });
  ...
  it('collects changed contact fields including company (kept for BC)', () => {
    ...
    const result = bcSubmitDataProcessing(data, accountSettings, decryptionFields, []);
  ...
  it('pushes form-field changes and maps password to newPassword', () => {
    ...
    const result = bcSubmitDataProcessing(data, accountSettings, [], extraFields);
...
describe('mapUserToAccountSettings', () => {
  it('returns an object of undefined fields when given no user', () => {
    expect(mapUserToAccountSettings(undefined)).toEqual({
      firstName: undefined,
      lastName: undefined,
      email: undefined,
  ...
  it('maps scalar fields and normalizes every extra-field and form-field union variant', () => {
    ...
    expect(mapUserToAccountSettings(user)).toEqual({
      firstName: 'Ada',
      lastName: 'Lovelace',
      email: 'ada@example.com',
      phoneNumber: '5551234',
  ...
  it('filters out unrecognized extra-field and form-field union members', () => {
    ...
    const result = mapUserToAccountSettings(user);
