...
describe('stencil', () => {
  ...
  it('can add a product with required options to a shopping list', async () => {
    ...
    server.use(
      ...
      graphql.mutation('AddItemsToShoppingList', ({ query, variables }) =>
        HttpResponse.json(addItemsToShoppingList({ query, variables })),
      ),
    );
...
describe('other/catalyst', () => {
  ...
  it('can add a variant of the product using a SKU to a shopping list', async () => {
    ...
    server.use(
      ...
      graphql.mutation('AddItemsToShoppingList', ({ query, variables }) => {
        return HttpResponse.json(addItemsToShoppingList({ query, variables }));
      }),
    );
